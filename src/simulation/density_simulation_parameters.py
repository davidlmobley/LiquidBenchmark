...
#DATA_PATH = os.path.join('/beegfs/DATA/mobley/dmobley/liquid_benchmark', "02_06_2017/")
DATA_PATH = os.path.join('/beegfs/DATA/mobley/dmobley/liquid_benchmark', "03_19_2017/")
